...
Ekstrinsik unsigned transactions adalah transaksi yang tidak berisi tanda tangan dari rekening yang mengeluarkan transaksi. Unsigned transactions extrinsics should be used with care because there is nobody paying a fee, becaused they are not signed. Karena ini, antrian transaksi kekurangan logika ekonomi untuk mencegah spam.
