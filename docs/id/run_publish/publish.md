...
Ada tiga metode untuk membuat proyek di SubQuery Managed Service: Anda dapat menggunakan UI, membuatnya secara langsung melalui alat `subql` cli, atau menggunakan tindakan GitHub otomatis.
