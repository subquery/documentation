...
- **隐藏项目：** 如果选中，如果选中，这将在公共 SubQuery 浏览器中隐藏项目。 如果您想要与社区分享您的 SubQuery，请保持此选项！ ![创建您的第一个项目。](/assets/img/projects-create.png)
...
![撤销对 GitHub 帐户的访问](/assets/img/project_auth_revoke.png)
