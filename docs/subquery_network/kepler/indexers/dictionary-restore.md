...
### Download snapshot from s3 bucket

```bash
curl -o dictionary.tar <Download_URL>
```

### Download snapshot via bittorrent
1. Install bittorrent client Aria2
