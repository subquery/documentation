  ...
  <div class="journey layout mt80">
    ...
    <div class="journeyItem">
      ...
      <div class="ct">
        ...
        <p>Leistung ist ein entscheidender Faktor in jedem Projekt. We’re here to give you guidance on how to optimise your SubQuery project to speed it up. <router-link :to="{path: '/build/optimisation.html'}">Read more</router-link></p>
      </div>
    </div>
  </div>
