...
| **Netzwerk**     | [Netzwerkspezifikationen](#network-spec) | Netzwerkspezifikationen     | Detail of the network to be indexed                                |
...
| Bereich  | v0.0.1 | v0.2.0 | Beschreibung                              |
| -------- | ------ | ------ | ----------------------------------------- |
| **file** | 𐄂      | String | Der Speicherort Ihrer GraphQL-Schemadatei |
