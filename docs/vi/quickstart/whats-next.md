...
- Giờ đây, bạn có thể dễ dàng xuất bản dự án của mình. SubQuery cung cấp giải pháp dịch vụ được quản lý, nơi bạn có thể triển khai dự án mới của mình. Bạn có thể triển khai nó trên [SubQuery Projects](https://project.subquery.network) và truy vấn nó bằng cách sử dụng [Explorer](https://explorer.subquery.network) của chúng tôi. Read this complete guide on how to [publish your new project to SubQuery Projects](../run_publish/publish.md).
