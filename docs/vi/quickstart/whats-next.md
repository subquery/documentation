...
- Giờ đây, bạn có thể dễ dàng xuất bản dự án của mình. SubQuery cung cấp giải pháp dịch vụ được quản lý, nơi bạn có thể triển khai dự án mới của mình. Bạn có thể triển khai nó trên [SubQuery Managed Service](https://managedservice.subquery.network) và truy vấn nó bằng cách sử dụng [Explorer](https://explorer.subquery.network) của chúng tôi. Đọc hướng dẫn đầy đủ này về cách [xuất bản dự án mới của bạn lên SubQuery Projects](../run_publish/publish.md).
