...
มีหลายกรณีที่คุณไม่ทราบพารามิเตอร์ทั้งหมดสําหรับ data source เมื่อเริ่มต้นโปรเจกต์ ตัวอย่างนี้คือ contract factory ที่จะสร้าง contract instances ใหม่ในภายหลัง เป็นไปไม่ได้เลยที่จะรู้ว่าการติดต่อแอดเดรสใด จะระบุไว้ล่วงหน้าสำหรับเรื่องนี้ และนี่คือการสร้าง data sources ใหม่
