...
The Project Manifest (`project.yaml`) file works as an entry point to your Harmony project. It defines most of the details on how SubQuery will index and transform the chain data. For
Harmony, there are three types of mapping handlers (and you can have more than one in each project):
