...
- Ahora, puede publicar fácilmente su proyecto. SubQuery provides a managed service solution where you can deploy your new project. Puedes implementarlo en [SubQuery Proyects](https://managedservice.subquery.network) y consultarlo usando nuestro [Explorador](https://explorer.subquery.network). Lea esta guía completa sobre cómo [publicar su nuevo proyecto en SubQuery Projects](../run_publish/publish.md).
