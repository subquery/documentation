...
Пока версия v0.2.0 находится в бете, вам необходимо определить ее во время инициализации проекта, запустив команду subql init --specVersion 0.2.0 проект_имя
