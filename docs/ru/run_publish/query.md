...
В верхней правой части игрового поля вы найдете кнопку *Docs*, которая откроет образец документации. Эта документация создается автоматически и помогает вам найти, какие сущности и методы вы можете запрашивать.
