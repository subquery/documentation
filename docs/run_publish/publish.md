...
There are three methods to create a project in the SubQuery Managed Service, you can use the UI, directly via the `subql` cli tool, or using an automated GitHub action.
