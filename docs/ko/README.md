  ...
  <div class="journey layout mt80">
    ...
    <div class="journeyItem">
      ...
      <div class="ct">
        ...
        <p>성능은 각 프로젝트에서 중요한 요소입니다. We’re here to give you guidance on how to optimise your SubQuery project to speed it up. <router-link :to="{path: '/build/optimisation.html'}">Find out more</router-link></p>
      </div>
    </div>
  </div>
