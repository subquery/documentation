...
Since we have a [many-to-many relationship](../../build/graphql#many-to-many-relationships), we add the `@derivedFrom` annotation to ensure that we are mapping to the right foreign key.
