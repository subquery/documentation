...
![Deleting a project from the staging slot](/assets/img/academy/delete_staging.png)
...
![Deleting a project from the production slot](/assets/img/academy/delete_production.png)
