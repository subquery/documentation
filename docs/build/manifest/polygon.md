...
The `chainId` is the network identifier of the blockchain. Examples in Polygon is `1` for mainnet, `3` for Ropsten, and `4` for Rinkeby. See https://chainlist.org/chain/1
